                    ...
                    <div className="absolute top-[2px] left-0 right-0 bottom-0 bg-[#1d2025] rounded-t-[46px] px-4 py-6 overflow-y-auto">
                        <div className="relative min-h-full pb-20">
                            <div className="flex justify-center mb-4">
                                <Image src={iceToken} alt="Ice Token" width={360} height={360} className="rounded-lg mr-2" />
                            </div>
                            <h1 className="text-2xl text-center mb-4">DEADPOOL AIRDROP</h1>
                            <p className="text-gray-300 text-center mb-4 font-normal">PROABABLY NOTHING</p>
                            <h2 className="text-base mt-8 mb-4">ITS TOTALLY PROBALBY SOMETHING</h2>
                            <div
